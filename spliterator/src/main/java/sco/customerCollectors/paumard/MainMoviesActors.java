package sco.customerCollectors.paumard;
...
import sco.customerCollectors.paumard.model.Actor;
import sco.customerCollectors.paumard.model.Movie;
...
public class MainMoviesActors {
    ...
    public static void main(String... args) throws IOException, URISyntaxException {
        ...
        Stream<String> lines
                = Files.lines(
                		Paths.get(ClassLoader.getSystemResource("m6/movies-mpaa.txt").toURI())
                );
        ...
        // to find actor that played in the greatest # of movies during a year
